...
void setup() {
  ...
  pinMode(10, OUTPUT); //Must declare 10(Uno) 53(Mega) an output and reserve it to keep SD card happy
...
void loop() 
{
  ...
  mySensorData.print(GPS.latitude,chipSelect); //Write measured latitude to file
  mySensorData.print(GPS.lat); //Which hemisphere N or S
  mySensorData.print(",");
  mySensorData.print(GPS.longitude,chipSelect); //Write measured longitude to file
